...
Use the Codex skill `sprint-execute`, or load `skills/sprint-protocol/references/phase-4-execution.md` and `skills/sprint-protocol/references/worker-guide.md`.
